...
//determine if u need to wear a coat based on temperature and wind speed
...
//     const double temperature_for_cost (45); // temperature below this value requires a coat
...
//     wear_coat = (temperature < temperature_for_cost && wind_speed > wind_speed_for_coat);
//     cout << "Do you need need to wear a coat using AND?" << wear_coat << endl;
